...
void MainWindow::OnCreate(HWND hWnd) 
{
    ...
    CreateWindowW(
        L"BUTTON", L"Алгоритм пчелиного улья",
        WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,
        100, 190, 200, 50,
        hWnd,
...
void MainWindow::OnCommand(HWND hWnd, int controlId) 
{
    ...
    case ID_BUTTON_HELP:
    {
        MessageBoxW(hWnd,
            ...
            L"3. Алгоритм пчелиного улья - поиск решения с использованием эвристических методов\n\n"
            L"Инструкция:\n"
            ...
            L"3. Запустите расчет\n\n"
            L"Бенчмарки:\n"
            L"При запуске бенчмарков ожидайте сообщения:\n"
            L"Бенчмарки записаны в файлы\n\n"
            L"Графики:\n"
            L"1. Алгоритмы. В них представлены графики зависимости функции качества от количества итераций.\n"
            L"2. Бенчмарки. В них представлены графики зависимости прогрессивной шкалы функции качества от времени выполнения алгоритма в миллисекундах.",
            L"Справка", 
